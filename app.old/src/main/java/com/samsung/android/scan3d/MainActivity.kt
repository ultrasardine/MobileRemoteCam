...
import com.samsung.android.scan3d.serv.StreamingManager
import com.samsung.android.scan3d.serv.NetworkMonitor
...
class MainActivity : FlutterActivity() {
    ...
    private fun startForegroundService() {
        ...
        // This will be implemented with a proper service in production
        ...
        when (requestCode) {
            MICROPHONE_PERMISSION_REQUEST_CODE -> {
                ...
                if (!granted && pendingPermissionType == "microphone") {
                    // Permission denied - send error with explanation
